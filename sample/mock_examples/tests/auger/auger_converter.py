...
converter.register_type('list', list, lambda a: SerializeResult('list', json.dumps(a), True), lambda a: json.loads(a))
converter.register_type('set', set, lambda a: SerializeResult('set', json.dumps(a), True), lambda a: set(json.loads(a)))
